"""
Send a dummy stay end reminders (Status Confirmation) enabled email to a test address for preview.
...
def main():
    ...
    print(f"\nSending stay end reminders enabled notification to {TEST_EMAIL}...\n")
    ...
    send_dead_mans_switch_enabled_notification(
        ...
        print("Stay end reminders enabled email: SENT")
