...
def main():
    ...
    try:
        ...
        samples = [
            ...
            ("dms_48h", "warning", "Status Confirmation: 48h before lease end", "Stay for Guest Name at Sample Property ends 2025-03-18. Please confirm checkout or renewal within 48 hours."),
