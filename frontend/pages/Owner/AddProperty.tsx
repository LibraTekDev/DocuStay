    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-4">
          {['Location', 'Details', 'Proof'].map((s, i) => (
        ...
        <div className="h-1 bg-slate-200 w-full absolute -z-0 max-w-4xl rounded-full translate-y-[-44px]">
           <div className="h-full bg-gradient-to-r from-blue-600 to-green-500 transition-all duration-700 rounded-full" style={{ width: `${((step - 1) / 2) * 100}%` }}></div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <p className="text-slate-500 mb-8">Final step: Securely prove ownership to activate full squatter defense.</p>
